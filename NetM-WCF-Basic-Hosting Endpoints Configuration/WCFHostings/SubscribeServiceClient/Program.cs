...
using SubscribeServiceClient.OrderServiceReference;
using SubscribeServiceClient.SubscribeServiceReference;
using NorthwindModel;

namespace SubscribeServiceClient
{
    class Program : ISubscribeServiceCallback
    {
        private SubscribeServiceReference.SubscribeServiceClient client;
        ...
        public void SubscribeTest()
        {
            ...
            client = new SubscribeServiceReference.SubscribeServiceClient(context);
