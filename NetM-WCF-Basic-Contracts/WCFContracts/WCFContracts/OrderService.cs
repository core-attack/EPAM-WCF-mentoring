...
namespace OrderService
{
    public class OrderService : IOrderService, ISubscribeServiceCallback
    {
        ...
        {
            Order order = Details(ows.OrderId);
            if (order != null)
            {
                switch (ows.Status)
                {
        ...
        public void IsInProgress(int orderId, DateTime date)
        {
            ...
            if (order != null)
            {
                ...
                {
                    ViewError(new FaultException(string.Format(ResourseHelper.GetResource("OrderRequiredDateIsLessThanNow"), order.RequiredDate, DateTime.Now)));
                }
        ...
        public void IsDone(int orderId, DateTime date)
        {
            Order order = Details(orderId);
            if (order != null)
            {
