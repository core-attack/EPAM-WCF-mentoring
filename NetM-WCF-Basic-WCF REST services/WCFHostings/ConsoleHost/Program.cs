...
namespace ConsoleHost
{
    class Program
    {
        ...
        {
            try {
                var categoryServiceHost = new WebServiceHost(typeof(CategoryService.CategoryService));
                var orderServiceHost = new WebServiceHost(typeof(OrderService.OrderService));
